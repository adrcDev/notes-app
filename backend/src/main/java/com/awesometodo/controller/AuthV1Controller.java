...
//        jwtRefreshTokenCookie.setAttribute("SameSite", "Strict");
    ...
    @ExceptionHandler({HttpRequestCookiesException.class,InvalidJwtRefreshTokenException.class, InvalidatedStatusJwtRefreshTokenException.class,InvalidatedStatusJwtRefreshTokenNoExtensionPeriodException.class, InvalidatedStatusJwtRefreshTokenExtensionPeriodExpiredException.class})
